...
namespace Microsoft.Framework.Runtime
{
    public class Project
    {
        ...
        private readonly Dictionary<NuGetFramework, TargetFrameworkInformation> _targetFrameworks = new Dictionary<NuGetFramework, TargetFrameworkInformation>();
        private readonly Dictionary<NuGetFramework, CompilerOptions> _compilationOptions = new Dictionary<NuGetFramework, CompilerOptions>();
        ...
        public CompilerOptions GetCompilerOptions(NuGetFramework frameworkName)
        {
            CompilerOptions options;
        ...
        public static NuGetFramework ParseFrameworkName(string targetFramework)
        {
            //if (targetFramework.Contains("+"))
            //{
            //    var portableProfile = NuGetFramework.Parse(targetFramework);
            ...
            //    return new NuGetFramework(targetFramework);
            //}
        ...
        public TargetFrameworkInformation GetTargetFramework(NuGetFramework targetFramework)
        {
            ...
            var frameworks = GetTargetFrameworks().ToDictionary(g => g.FrameworkName);

            var nearest = reducer.GetNearest(targetFramework, frameworks.Keys);

            if (nearest != null)
            {
                targetFrameworkInfo = frameworks[nearest];
            }

            return targetFrameworkInfo ?? _defaultTargetFrameworkConfiguration;
        }

        private static string MakeDefaultTargetFrameworkDefine(Tuple<string, NuGetFramework> frameworkDefinition)
        {
